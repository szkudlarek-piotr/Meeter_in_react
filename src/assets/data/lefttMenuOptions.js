export const leftMenuOptions = [
    ...
    {"id": "addClique", "text": "Dodaj klikę", "state": "addCliques"},
    {"id": "addVisit", "text": "Dodaj wizytę", "state": "addVisit"},
    {"id": "addMeeting", "text": "Dodaj spotkanie", "state": "addMeeting"},
    {"id": "addEvent", "text": "Dodaj wydarzenie", "state": "addEvent"},
    {"id": "addPlace", "text": "Dodaj miejsce", "state": "addPlace"},
    ...
    {"id": "setQuotesPrivacy", "text": "Modyfikuj prywatność swoich cytatów", "state": "setQuotesPrivacy"}
